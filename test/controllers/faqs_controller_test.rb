...
class FaqsControllerTest < ActionController::TestCase
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post :create, faq: { answer: @faq.answer, faq_section_id: @faq.faq_section_id, question: @faq.question }
    end
  ...
  test "should update faq" do
    patch :update, id: @faq, faq: { answer: @faq.answer, faq_section_id: @faq.faq_section_id, question: @faq.question }
    assert_redirected_to faq_path(assigns(:faq))
  end
